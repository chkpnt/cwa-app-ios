...
struct Cwa_Internal_V2_RiskCalculationParameters {
  ...
  fileprivate var _trlEncoding: Cwa_Internal_V2_TransmissionRiskLevelEncoding? = nil
}
...
struct Cwa_Internal_V2_MinutesAtAttenuationFilter {
  ...
  fileprivate var _attenuationRange: Cwa_Internal_V2_Range? = nil
  fileprivate var _dropIfMinutesInRange: Cwa_Internal_V2_Range? = nil
}
...
struct Cwa_Internal_V2_TrlFilter {
  ...
  fileprivate var _dropIfTrlInRange: Cwa_Internal_V2_Range? = nil
}
...
struct Cwa_Internal_V2_NormalizedTimeToRiskLevelMapping {
  ...
  fileprivate var _normalizedTimeRange: Cwa_Internal_V2_Range? = nil
}
