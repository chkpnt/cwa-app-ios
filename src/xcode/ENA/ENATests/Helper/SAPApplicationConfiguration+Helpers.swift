...
extension Cwa_Internal_V2_ApplicationConfigurationIOS {

	static var riskCalculationAppConfig: Cwa_Internal_V2_ApplicationConfigurationIOS {
		makeAppConfig(w_low: 1.0, w_med: 0.5, w_high: 0.5)
	}

	/// Makes an mock `Cwa_Internal_V2_ApplicationConfigurationIOS`
	///
	...
	) -> Cwa_Internal_V2_ApplicationConfigurationIOS {
