...
final class CachedAppConfigurationMock: AppConfigurationProviding {
	...
	init(appConfigurationResult: Result<Cwa_Internal_V2_ApplicationConfigurationIOS, Error> = .success(Cwa_Internal_V2_ApplicationConfigurationIOS())) {
	...
	private var appConfigurationResult: Result<Cwa_Internal_V2_ApplicationConfigurationIOS, Error>
