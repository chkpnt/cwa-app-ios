...
class HomeUnknown48hRiskCellConfiguratorTests: XCTestCase {
	...
	func test_unknownRiskLevelCell_shouldHaveDifferentHash1() {
		...
		let configurator1 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 0, detectionMode: .manual, manualExposureDetectionState: .possible, previousRiskLevel: .low)
		let configurator2 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 0, detectionMode: .automatic, manualExposureDetectionState: .possible, previousRiskLevel: .high)
	...
	func test_unknownRiskLevelCell_shouldBeEqual() {
		let date = Date()
		let configurator1 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 0, detectionMode: .manual, manualExposureDetectionState: .possible, previousRiskLevel: .high)
		let configurator2 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 0, detectionMode: .manual, manualExposureDetectionState: .possible, previousRiskLevel: .high)
	...
	func test_unknownRiskLevelCell_shouldntBeEqual2() {
		let date = Date()
		let configurator1 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 0, detectionMode: .manual, manualExposureDetectionState: .possible, previousRiskLevel: .high)
		let configurator2 = HomeUnknown48hRiskCellConfigurator(state: .idle, lastUpdateDate: date, detectionInterval: 900, detectionMode: .manual, manualExposureDetectionState: .waiting, previousRiskLevel: .high)
